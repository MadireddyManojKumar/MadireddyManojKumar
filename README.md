...
I'm a DevOps/SRE-focused engineer building expertise in cloud infrastructure, automation, and reliability engineering, with a growing specialization in AI/MLOps pipelines. I enjoy designing systems that are resilient, observable, and self-healing — and I'm currently deepening my skills across AWS, Kubernetes, and CI/CD automation while extending into GenAI infrastructure (LLMs, RAG, model observability).

- 🔭 Currently strengthening skills in **AWS (SageMaker), Kubernetes, and CI/CD pipeline design**
- 🌱 Learning to bridge traditional **DevOps** with **AI/MLOps** workflows
- 🎯 Targeting **SRE / DevOps / Production Engineer** roles at top-tier tech companies
- 📍 Based in Texas, USA
- 💬 Ask me about Linux internals, incident troubleshooting, or building CI/CD pipelines from scratch
...
**🧭 SRE Practices**
`SLI/SLO/SLA` · `Incident Response` · `Root Cause Analysis` · `Postmortems` · `On-Call & Escalation` · `Capacity Planning` · `Disaster Recovery (RTO/RPO)` · `Chaos Engineering`
